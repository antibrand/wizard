...
class Wizard_Customizer_Importer {
	/**
	...
	public static function import( $customizer_import_file_path ) {
		...
		Wizard_Logger::get_instance()->info( __( 'The customizer import has finished successfully', '@@textdomain' ) );
		return true;
	}
	...
	public static function import_customizer_options( $import_file_path ) {
		...
		if ( isset( $data['options'] ) ) {
			...
			foreach ( $data['options'] as $option_key => $option_value ) {
				$option = new Wizard_Customizer_Option( $wp_customize, $option_key, array(
					'default'    => '',
					'type'       => 'option',
